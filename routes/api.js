...
var creatorList = ['@bayganzz','@zhirrrgans','@zhirr_ajalah','@zahiranjay', '@zahirganssss','@zhirrganteng','@zahirrgantengg'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'bayganz') return res.json(loghandler.invalidKey)
...
router.get('/tiktod/stalk', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'bayganz') return res.json(loghandler.invalidKey)
